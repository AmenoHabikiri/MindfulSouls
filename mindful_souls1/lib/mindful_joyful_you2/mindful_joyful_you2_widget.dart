...
class MindfulJoyfulYou2Widget extends StatefulWidget {
  const MindfulJoyfulYou2Widget({Key? key}) : super(key: key);

  @override
  _MindfulJoyfulYou2WidgetState createState() =>
      _MindfulJoyfulYou2WidgetState();
}

class _MindfulJoyfulYou2WidgetState extends State<MindfulJoyfulYou2Widget> {
